...
final class cachehelper {
    ...
    public function __construct() {
        ...
        if (!is_dir($this->cacheDir)) {
            ...
            mkdir($this->cacheDir, 0757, true);
            chmod($this->cacheDir, 0757);
        }
    }
    ...
    public function add($key, $data, $cache_seconds = 60) {
        ...
        if (!flock($fp, LOCK_EX)) {
            fclose($fp);
            LogUtil::logmsg($lockfile . ' lock fail', 'ErrLock');
...
/*
* __CLASS__ = cachehelper
* __DIR__ = E:\baidubranch\developer\application\libraries
* __FILE__ = E:\baidubranch\developer\application\libraries\cachehelper.php
* __FUNCTION__ = __construct
* __LINE__ = 代码在文件里的行号
* __METHOD__ = cachehelper::__construct
* __NAMESPACE__ =
*/